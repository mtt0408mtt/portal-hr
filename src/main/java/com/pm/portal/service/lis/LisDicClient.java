...
//				"http://lis-service/lis/get_dic_select",vars, String.class);
//		
...
//	}
	...
	public String getDicSendUnit(Map<String, Object> vars) {
		...
		String result=restTpl.postForObject(
				"http://lis-service/lis/get_dic_sendUnit",vars, String.class);
	...
	public String getDicPatientType(Map<String, Object> vars) {
		...
		String result=restTpl.postForObject(
				"http://lis-service/lis/get_patient_type",vars, String.class);
	...
	public String getDicApplyType(Map<String, Object> vars) {
		...
		String result=restTpl.postForObject(
				"http://lis-service/lis/get_apply_type",vars, String.class);
	...
	public String getDicByDmlb(Map<String, Object> vars) {
		...
		String result=restTpl.postForObject(
				"http://lis-service/lis/get_dic_dmlb",vars, String.class);
	...
	public String getSampleType(Map<String, Object> vars) {
		...
		String result=restTpl.postForObject(
				"http://lis-service/lis/get_sample_type",vars, String.class);
	...
	public String getCombination(Map<String, Object> vars) {
		...
		String result=restTpl.postForObject(
				"http://lis-service/lis/get_combination",vars, String.class);
	...
	public String getCombCategory(Map<String, Object> vars) {
		...
		String result=restTpl.postForObject(
				"http://lis-service/lis/get_comb_category",vars, String.class);
	...
	@HystrixCommand(fallbackMethod = "getInstrumentFallback", groupKey = "getInstrumentGroup", commandKey = "getInstrumentCommandKey", commandProperties = {
			@HystrixProperty(name = "execution.isolation.thread.timeoutInMilliseconds", value = "20000") }, threadPoolProperties = {
					@HystrixProperty(name = "coreSize", value = "5") })
	public String getInstrument(Map<String, Object> vars) {
		for (Map.Entry<String, Object> entry : vars.entrySet()) {  
		    System.out.println("Key = " + entry.getKey() + ", Value = " + entry.getValue());  
		}  
		String result=restTpl.postForObject(
				"http://lis-service/lis/get_instrument",vars, String.class);
	...
	public String getInstrumentFallback(Map<String, Object> vars) {
		return JSONObject.toJSONString(Result.error(CodeMsg.LIS_SERVER_ERROR));
	}
