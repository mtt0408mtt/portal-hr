 ...
 */
@Service
public class SbTypeClient {

    private final RestTemplate restTpl;

    @Autowired
    public SbTypeClient(RestTemplate restTpl) {
    ...
    public String list(Map<String, Object> vars) {
        return restTpl.postForObject("http://device/device/sbType/list",vars,String.class);
    }
    ...
    public String saveOrUpdate(Map<String, Object> vars) {
        return restTpl.postForObject("http://device/device/sbType/saveOrUpdate",vars,String.class);
    }
    ...
    public String delete(Long id) {
        return restTpl.postForObject("http://device/device/sbType/delete",id,String.class);
    }
