 ...
 */
@Service
public class SbArchiveFileClient {

    private final RestTemplate restTpl;

    @Autowired
    public SbArchiveFileClient(RestTemplate restTpl) {
    ...
    public String list(Map<String, Object> vars) {
        return restTpl.postForObject("http://device/device/sbArchiveFile/list",vars,String.class);
    }
    ...
    public String saveOrUpdate(Map<String, Object> vars) {
        return restTpl.postForObject("http://device/device/sbArchiveFile/saveOrUpdate",vars,String.class);
    }
    ...
    public String delete(Long id) {
        return restTpl.postForObject("http://device/device/sbArchiveFile/delete",id,String.class);
    }
